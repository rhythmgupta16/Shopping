...
class FeaturedItem extends StatefulWidget {
  ...
  FeaturedItem({@required this.featured});
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            image: NetworkImage(widget.featured.imgURL ??
                  ...
                  child: Row(
                    children: <Widget>[
                      (double.parse(widget.featured.rating) >= 4.0)
                          ...
                          : (double.parse(widget.featured.rating) < 4.0 &&
                                  double.parse(widget.featured.rating) > 2.0)
                              ? Container(
                                  child: new IconTheme(
                                    data:
